...
#
# Generated by export_simulation on Thu Feb 01 21:56:24 +0800 2018
#
################################################################################
...
switch to the './WeightBuffer3.sh' script.

./WeightBuffer3.sh -reset_run
...
./WeightBuffer3.sh -noclean_files

For more information on the script, please type './WeightBuffer3.sh -help'.
