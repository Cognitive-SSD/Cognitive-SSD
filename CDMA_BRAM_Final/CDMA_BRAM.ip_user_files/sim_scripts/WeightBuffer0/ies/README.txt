...
#
# Generated by export_simulation on Thu Feb 01 21:43:38 +0800 2018
#
################################################################################
...
switch to the './WeightBuffer0.sh' script.

./WeightBuffer0.sh -reset_run
...
./WeightBuffer0.sh -noclean_files

For more information on the script, please type './WeightBuffer0.sh -help'.
