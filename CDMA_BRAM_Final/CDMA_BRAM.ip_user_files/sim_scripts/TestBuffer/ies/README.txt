...
#
# Generated by export_simulation on Wed Jan 24 13:52:19 +0800 2018
#
################################################################################
...
switch to the './TestBuffer.sh' script.

./TestBuffer.sh -reset_run
...
./TestBuffer.sh -noclean_files

For more information on the script, please type './TestBuffer.sh -help'.
