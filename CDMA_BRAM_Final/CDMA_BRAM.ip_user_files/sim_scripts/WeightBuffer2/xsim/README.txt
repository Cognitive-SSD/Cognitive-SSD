...
#
# Generated by export_simulation on Fri Feb 02 23:35:01 +0800 2018
#
################################################################################
...
switch to the './WeightBuffer2.sh' script.

./WeightBuffer2.sh -reset_run
...
./WeightBuffer2.sh -noclean_files

For more information on the script, please type './WeightBuffer2.sh -help'.
