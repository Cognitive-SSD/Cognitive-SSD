...
#
# Generated by Vivado on Tue Jan 23 15:35:39 +0800 2018
# IP Build 1577682 on Fri Jun  3 12:00:54 MDT 2016 
#
# usage: CMDA_DRAM.sh [-help]
# usage: CMDA_DRAM.sh [-lib_map_path]
# usage: CMDA_DRAM.sh [-noclean_files]
# usage: CMDA_DRAM.sh [-reset_run]
#
...
# executing this script. Please type 'CMDA_DRAM.sh -help' for more information.
#
...
vhdlan_opts="-full64"
vcs_elab_opts="-load "J:/Vivado2016/Vivado/2016.2/lib/win64.o/libxil_vcs.dll:xilinx_register_systf" -full64 -debug_pp -t ps -licqueue -l elaborate.log"
vcs_sim_opts="-ucli -licqueue -l simulate.log"

# Design libraries
design_libs=(xil_defaultlib xpm processing_system7_bfm_v2_0_5 lib_pkg_v1_0_2 lib_srl_fifo_v1_0_2 fifo_generator_v13_1_1 lib_fifo_v1_0_5 lib_cdc_v1_0_2 axi_datamover_v5_1_11 axi_sg_v4_1_3 axi_cdma_v4_1_9 proc_sys_reset_v5_0_9 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_9 axi_data_fifo_v2_1_8 axi_crossbar_v2_1_10 blk_mem_gen_v8_3_3 axi_bram_ctrl_v4_0_8 axi_protocol_converter_v2_1_9 axi_clock_converter_v2_1_8 axi_dwidth_converter_v2_1_9)

# Simulation root library directory
sim_lib_dir="vcs"

# Script info
echo -e "CMDA_DRAM.sh - Script generated by export_simulation (Vivado v2016.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/CMDA_DRAM/ip/CMDA_DRAM_processing_system7_0_0/sim/CMDA_DRAM_processing_system7_0_0.v" \
    "$ref_dir/../../../bd/CMDA_DRAM/hdl/CMDA_DRAM.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/CMDA_DRAM/ip/CMDA_DRAM_axi_cdma_0_0/sim/CMDA_DRAM_axi_cdma_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/CMDA_DRAM/ip/CMDA_DRAM_proc_sys_reset_0_0/sim/CMDA_DRAM_proc_sys_reset_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/CMDA_DRAM/ip/CMDA_DRAM_xbar_0/sim/CMDA_DRAM_xbar_0.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work blk_mem_gen_v8_3_3 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/CMDA_DRAM/ip/CMDA_DRAM_axi_bram_ctrl_0_1/sim/CMDA_DRAM_axi_bram_ctrl_0_1.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/CMDA_DRAM/ip/CMDA_DRAM_blk_mem_gen_0_1/sim/CMDA_DRAM_blk_mem_gen_0_1.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/CMDA_DRAM/ip/CMDA_DRAM_auto_pc_0_1/sim/CMDA_DRAM_auto_pc_0.v" \
    "$ref_dir/../../../bd/CMDA_DRAM/ip/CMDA_DRAM_auto_pc_1_1/sim/CMDA_DRAM_auto_pc_1.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work axi_clock_converter_v2_1_8 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
  ...
  vlogan -work axi_dwidth_converter_v2_1_9 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/CMDA_DRAM/ip/CMDA_DRAM_auto_ds_0_1/sim/CMDA_DRAM_auto_ds_0.v" \
    "$ref_dir/../../../bd/CMDA_DRAM/ip/CMDA_DRAM_auto_us_0/sim/CMDA_DRAM_auto_us_0.v" \
    "$ref_dir/../../../bd/CMDA_DRAM/ip/CMDA_DRAM_auto_pc_2/sim/CMDA_DRAM_auto_pc_2.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.CMDA_DRAM xil_defaultlib.glbl -o CMDA_DRAM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./CMDA_DRAM_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./CMDA_DRAM.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key CMDA_DRAM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc CMDA_DRAM_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./CMDA_DRAM.sh -help\" for more information)\n"
    exit 1
  fi
