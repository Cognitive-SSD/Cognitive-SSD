...
#
# Generated by export_simulation on Tue Jan 23 15:35:39 +0800 2018
#
################################################################################
...
switch to the './CMDA_DRAM.sh' script.

./CMDA_DRAM.sh -reset_run
...
./CMDA_DRAM.sh -noclean_files

For more information on the script, please type './CMDA_DRAM.sh -help'.
